...
public class AddEleve extends JFrame{
   ...
   // formulaire.setLayout(new BorderLayout());
    ...
    private void addActionPerformed(ActionEvent evt) {                                        
        ...
        int classe= Integer.parseInt(jTextFieldClasse.getText());
       // int bulletin= Integer.parseInt(jTextFieldBulletin.getText());
        Eleve neweleve;
        neweleve = new Eleve(16,nom,prenom,classe);
        eleve.add(neweleve);
        this.dispose();
